...
//			requestRentBasicVO.setRentMainTel(rentMainTel);
			...
			/*#################################### S T E P - 3 ####################################*/
			ArrayList<RentDetFacVO> requestRentDetFacVOList = new ArrayList<RentDetFacVO>();
			RentDetVO requestRentDetVO = new RentDetVO();
			RentCloseVO requestRentCloseVO = new RentCloseVO();
			...
			if(selectedDetFacIcon != null && !selectedDetFacIcon.equals("")) {
				...
				for(String rentDetFacSeq : detFacSeqArray) {
					...
					requestRentDetFacVO.setRentDetFacSeq(Integer.parseInt(rentDetFacSeq));
			...
			/*requestRentDetVO 세팅*/
			requestRentDetVO.setMaxHeadCount(maxHeadCount);

			/*requestRentCloseVO 세팅*/
			requestRentCloseVO.setRegCloseCd(regCloseCd);

			requestRentCloseVO.setCusCloseStart(cusCloseStart);
			requestRentCloseVO.setCusCloseEnd(cusCloseEnd);
			...
			System.out.println("selectedDetFacIcon::" + selectedDetFacIcon);
			System.out.println("selectedDetFacIcon::" + cusClosedate);
