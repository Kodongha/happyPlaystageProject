	...
	<div class="container">
		...
		<form action="#">
			...
			<div class="form-group">
				...
				<div class="form-group">
					<input type="text" class="col-sm-10 col-xs-10 form-control" id="address" placeholder="주소를 입력해주세요." name="address" style="width: 80%">
					<button type="button" id="addressAddBtn" class="col-sm-2 col-xs-2 btn btn btn-primary" style="width: 15%; float: right;">주소등록</button>
				</div>
			</div> 
