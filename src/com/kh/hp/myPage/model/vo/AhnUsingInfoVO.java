...
public class AhnUsingInfoVO implements java.io.Serializable{
	...
	public AhnUsingInfoVO(int propSeq, int rentSeq, int userSeq, String propNm, String propPhone, String propEmail,
	...
	public String toString() {
		return "AhnUsingInfoVO [propSeq=" + propSeq + ", rentSeq=" + rentSeq + ", userSeq=" + userSeq + ", propNm="
